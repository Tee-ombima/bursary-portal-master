...
from .views import update_field_with_custom_input_view



urlpatterns = [
    # path('admin/update_field_with_custom_input/', update_field_with_custom_input_view, name='update_field_with_custom_input'),
    ...
    path('update_field/', update_field_with_custom_input_view, name='update_field_with_custom_input'),
